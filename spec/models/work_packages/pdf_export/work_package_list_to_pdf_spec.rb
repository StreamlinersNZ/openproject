...
RSpec.describe WorkPackage::PDFExport::WorkPackageListToPdf do
  ...
  context "with a request for a PDF Table" do
    ...
    describe "grouped" do
      ...
      describe "grouped by a phase" do
        ...
        shared_let(:user_permissions) { %w[view_work_packages export_work_packages view_project_phases] }
        shared_let(:user) { create(:admin) }

        let(:column_names) { %w[id subject status project_phase] }
